...
```bash
# OpenWrt >= 25:
curl -L https://github.com/zerolabnet/ssclash/releases/download/v4.6.0/luci-app-ssclash-4.6.0-r1.apk -o /tmp/luci-app-ssclash-4.6.0-r1.apk
apk add --allow-untrusted /tmp/luci-app-ssclash-4.6.0-r1.apk

# OpenWrt < 25:
curl -L https://github.com/zerolabnet/ssclash/releases/download/v4.6.0/luci-app-ssclash_4.6.0-r1_all.ipk -o /tmp/luci-app-ssclash_4.6.0-r1_all.ipk
opkg install /tmp/luci-app-ssclash_4.6.0-r1_all.ipk
...
- **Хранить правила и proxy-providers в RAM**: Каталоги rulesets и proxy-providers размещаются в tmpfs для сохранения ресурса NAND-чипа
- **Добавить HWID-заголовки к подпискам**: Автоматическое добавление HWID-заголовков к proxy-providers (совместимость с Remnawave)
